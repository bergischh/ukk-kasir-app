...
@section('content')
        ...
        <div class="card mb-2 p-5">
            <form class="row g-3" method="POST" action="{{ route('product.update', $products['id']) }}" enctype="multipart/form-data" onsubmit="return cleanPriceBeforeSubmit()">
                @csrf
                @method('PATCH')
                ...
                <div class="col-md-6 mt-5">
                    ...
                    <input type="number" class="form-control" id="stock" name="stock" value="{{ $products['stock'] }}" disabled>
                ...
                <div class="col-md-6 mt-5">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="harga" name="harga" value="{{ $products['harga'] }}" oninput="formatRupiah(this)">
                    </div>
                </div>
